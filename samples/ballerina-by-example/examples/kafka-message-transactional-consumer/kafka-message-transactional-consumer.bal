...
@Description{value : "Service level annotation to provide Kafka consumer configuration. Here we set isolation.level = read_committed so
it will only consume non transactional or committed transactional messages"}
@kafka:configuration {
