...
package org.ballerinalang.kafka.test.ssl;
...
public class KafkaConsumerAndProducerWithSSLTest {
    ...
    private String configFile = "ssl/kafka_ssl.bal";
    ...
    @Test(description = "Test consumer polling with SSL", dependsOnMethods = {"testKafkaProducerWithSSL"})
    ...
    public void testKafkaConsumerWithSSL() {
        try {
            await().atMost(10000, TimeUnit.MILLISECONDS).until(() -> {
                ...
                Assert.assertEquals(returnBValues[0].stringValue(), message);
    ...
    public void testKafkaConsumerSSLConnectNegative() {
        ...
        String errorMessage = "Failed to send message. Failed to update metadata after 60000 ms.";
