 ...
 */
public class NetKafkaConsumerPauseTest {
    ...
    public void setup() throws IOException {
        result = BCompileUtil.compile("consumer/kafka-consumer-pause.bal");
    ...
    public void testKafkaConsumeWithPause() {
        ...
        Assert.assertEquals(((BRefValueArray) returnBValues[0]).size(), 0);
        ...
        BStruct tpReturned = (BStruct) ((BRefValueArray) returnBValues[0]).get(0);
