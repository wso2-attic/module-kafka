...
/**
 * Test cases for ballerina.net.kafka consumer ( with manual commit enabled ) native functions.
 */
public class NetKafkaConsumerManualCommitTest {
    ...
    @Test(description = "Test Basic consumer pooling with manual offset commit")
