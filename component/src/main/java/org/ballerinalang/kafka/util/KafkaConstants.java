...
public class KafkaConstants {
    ...
    public static final String PARAMETER_CONSUMER_NAME = KAFKA_NATIVE_PACKAGE + BLOCK_SEPARATOR + CONSUMER_STRUCT_NAME;
    public static final String PARAMETER_RECORD_ARRAY_NAME =
            KAFKA_NATIVE_PACKAGE + BLOCK_SEPARATOR + CONSUMER_RECORD_STRUCT_NAME + ARRAY_INDICATOR;
    public static final String PARAMETER_PARTITION_OFFSET_ARRAY_NAME =
            KAFKA_NATIVE_PACKAGE + BLOCK_SEPARATOR + OFFSET_STRUCT_NAME + ARRAY_INDICATOR;
